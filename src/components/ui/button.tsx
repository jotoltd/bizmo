...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-electric text-black hover:brightness-110 focus-visible:ring-electric",
        ghost:
          "text-slate-300 hover:text-white hover:bg-white/5 focus-visible:ring-slate-500",
        outline:
          "border border-white/10 text-slate-100 hover:border-electric hover:text-electric",
      },
      size: {
